...
class MooWoodle_PostType_Product
{
	...
	public function add_meta_boxes()
	{
		...
		add_meta_box('course_program', 'Programa del curso', array(&$this, 'add_course_program_meta_box'));
	}
...
<?php
	...
	public function add_course_program_meta_box()
	{
		global $post;
		$field_value = get_post_meta($post->ID, '_course_program', false);
		wp_editor($field_value[0], '_course_program');
	}
	...
	public function save_product_callback($post_id)
	{
		...
		if (isset($_POST['_course_program'])) {
			update_post_meta($post_id, '_course_program', $_POST['_course_program']);
		}
